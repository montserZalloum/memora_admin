...
def get_gamification_settings() -> dict:
	...
	return {
		...
		"max_streak_multiplier_percent": settings.max_streak_multiplier_percent
		if settings.max_streak_multiplier_percent is not None
		else 50,
		"max_devices_per_player": settings.max_devices_per_player
		if settings.max_devices_per_player is not None
		else 3,
