...
- [x] **PERF-13** — Stats recompute storm (HIGH)
- [x] **PERF-14** — `exists()` loops in subscription/voucher (MEDIUM)
- [x] **PERF-15** — Sequential dirty sync processing (MEDIUM)
- [x] **PERF-16** — `get_memory_mastery()` partition scan (MEDIUM)
- [x] **PERF-17** — Full CSV decryption for export (MEDIUM)
- [x] **PERF-18** — Session Redis GET per request (MEDIUM)
